...
public class Ticket {
    ...
    private Object[] followerIds;
    private Object[] followupIds;
    private long forumTopicId;
    private long groupId;
    private boolean hasIncidents;
    private long id;
    private boolean isPublic;
    private Object[] macroIds;
    ...
    private Object[] sharingAgreementIds;
    ...
    public Ticket(@JsonProperty("allow_attachments") boolean allowAttachments,
                  ...
                  @JsonProperty("email_cc_ids") Object[] emailCCIds,
                  @JsonProperty("external_id") String externalId,
                  @JsonProperty("follower_ids") Object[] followerIds,
                  @JsonProperty("followup_ids") Object[] followupIds,
                  @JsonProperty("forum_topic_id") long forumTopicId,
                  @JsonProperty("group_id") long groupId,
                  @JsonProperty("has_incidents") boolean hasIncidents,
                  @JsonProperty("id") long id,
                  @JsonProperty("is_public") boolean isPublic,
                  @JsonProperty("macro_ids") Object[] macroIds,
                  ...
                  @JsonProperty("sharing_agreement_ids") Object[] sharingAgreementIds,
